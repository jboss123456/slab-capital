...
USD_TO_CAD = 1.36
MIN_COMPS = 3
BIG_UP = 1.5 # a >+50% single-day move is treated as 'big' (needs confirmation)
BIG_DN = 0.6 # a <-40% single-day move is 'big'
CONFIRM_TOL = 0.20 # a staged big move is confirmed if the next reading is within 20%
